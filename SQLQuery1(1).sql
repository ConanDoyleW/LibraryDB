...
(CALLNUM NVARCHAR(15)NOT NULL,/*索书号*/
 ...
 CONSTRAINT PBOOK_Prim PRIMARY KEY(BARCODE,CALLNUM)
 );
 ...
 (BN NVARCHAR(40)NOT NULL,/*书名*/
  ...
  CONSTRAINT PKBOOK_Prim PRIMARY KEY(CALLNUM)
  );
...
/*书籍评论表*/
  ...
  ( CALLNUM NVARCHAR(15)NOT NULL,/*索书号*/
    ...
    CNUM NVARCHAR(20) NOT NULL,/*证件号*/
    CONSTRAINT BOOKHAVECOMMENTS_Prim PRIMARY KEY(CALLNUM,CNUM)
  );
/*借阅表*/ 
 CREATE TABLE BOOKB
 ( CNUM NVARCHAR(20) NOT NULL,/*证件号*/
   BARCODE NVARCHAR(15)NOT NULL,/*条码号*/
   BTIME DATETIME NOT NULL,/*借书日期*/
   RTIME DATETIME NOT NULL,/*还书日期*/ 
